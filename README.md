...
Before running the project for the first time, install all required dependencies:
...
Gives you full control over the build configuration.

Most projects never need to run eject.
